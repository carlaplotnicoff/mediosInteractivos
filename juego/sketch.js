...
function draw() {
  ...
  if (estado == 0) {
    ...
    strokeWeight(3)
    stroke(198, 55, 23);
    rect(width / 2 - 230, height / 2 + 210, 485, 70);
    fill(198, 55, 23);
    noStroke();
    textFont('Economica');
    text("Haz click en cualquier parte de la pantalla para empezar", width / 2 - 200, height / 2 + 257);
    textFont('Pattaya');
    textSize(80);
...
//instrucciones
    ...
    strokeWeight(3);
    stroke(66, 134, 244);
    rect(width / 2 - 133, height / 2 + 210,400, 70);
    fill(46, 132, 219);
    noStroke();
    textFont('Economica');
    text("Haz click en cualquier parte de la pantalla para seguir", width / 2 - 120, height / 2 + 257);
    textFont('Pattaya');
    textSize(55);
    ...
    strokeWeight(3);
    stroke(66, 134, 244)
    rect(width / 2 - 133, height / 2 + 210, 415, 75)
    fill(46, 132, 219);
    noStroke();
    textFont('Economica');
    text("Haz click en cualquier parte de la pantalla para seguir", width / 2 - 115, height / 2 + 257);
    textFont('Pattaya');
    textSize(55);
