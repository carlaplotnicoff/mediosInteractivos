  ...
  if (estado == 0) {
    ...
    if (mouseIsPressed == true) {
      if (mouseX > posXbot11 - (tamBot11 / 2) && mouseX < posXbot11 - (tamBot11 / 2) + tamBot11 &&
        ...
        if (jugador1 == 1) {
          image(miPepperoni, posXbot11 - 250, posYbot11 - 10, 150, 150)
        }

        if (jugador1 == 2) {
          image(miChampi, posXbot11 - 250, posYbot11 - 10, 150, 150)
        }
      }
    }
    ...
    //pizza de  fondo
    image(miMantel, 0, 0, width, height);
    image(miPizza, 100, 300, 550 * width / 700, 350 * width / 700);
  ...
  if (estado == 1) {
    ...
    if (mouseX > 100 && mouseY > 100 && mouseX < 650 && mouseY < 650) {
      ...
      if (ingredienteSel == 5) {
        ...
        idealPepperoni2 = idealPepperoni2 + 1;
      }
