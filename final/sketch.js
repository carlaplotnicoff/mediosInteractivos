...
//si se escoge multijugador
    ...
    stroke(0);
    strokeWeight(5);
    text("Instrucciones", width / 2 - 100, height / 2 - 180);
    textSize(30);
    fill(0);
    textFont('Courgette');
    strokeWeight(0);
    text("De Italia viene una pizza cargada de...", width / 2 - 220, height / 2 - 110);
    textSize(27);
    fill(0);
    noStroke();
    textFont('Economica');
    text("Los  dos jugadores deben mirar la", width / 2 - 120, height / 2 - 50);
    text("pantalla todo el tiempo. Primero el", width / 2 - 120, height / 2);
    text("jugador 1, pone un ingrediente la", width / 2 - 120, height / 2 + 50);
    text("cantidad de veces que desee, el", width / 2 - 120, height / 2 + 100);
    text("jugador 2 pone los ingredientes que", width / 2 - 120, height / 2 + 150);
    text("puso el jugador 1 más otro nuevo.", width / 2 - 120, height / 2 + 200);
    text("el juego continua hasta que alguno", width / 2 - 120, height / 2 + 250);
    text("no se acuerde de los ingredientes.", width / 2 - 120, height / 2 + 300);
    ...
    text("Jugador 1", width / 2 - 50, height / 2);
    textSize(25);
    text("(nivel 3)", width / 2 - 20, height / 2 + 50);
    ...
    fill(0);
    noStroke();
    text(numChampis2, 100, 120);
    text(idealChampis2, 100, 150);
    ...
    // multijugador
    ///estado donde el jugador hace la pizza que el otro le puso a hacer (nivel 3)
    //juego
    //pizza de  fondo
    image(miMantel, 0, 0, width, height);
    image(miPizza, -10, 120, 550 * width / 530, 350 * width / 530);
    ...
    noStroke();
    textSize(25)
    text("GANÓ JUGADOR 2!", width / 2 - 50, height / 2);
    textSize(15)
    text("haz click para  jugar otra vez", width / 2 - 100, height / 2 + 50);
    image(confeti, 0, 0, width, height);
    ...
    noStroke();
    textSize(25)
    text("GANÓ JUGADOR 1!", width / 2 - 50, height / 2);
    textSize(15)
    text("haz click para  jugar otra vez", width / 2 - 100, height / 2 + 50);
    image(confeti, 0, 0, width, height);
  ...
  if (estado == 1) {
    ...
    //delimitar espacio en el que se pueden poner ingredientes dentro de la pizza
     if (mouseX > 100 && mouseY > 100 && mouseX < 650 && mouseY < 650) {
      ...
      if (ingredienteSel == 5) {
        ...
        idealPerpperoni3 = idealPepperoni3 + 1;
      }
    ...
    if (mouseX > posXbot5 - (tamBot5 / 2) && mouseX < posXbot5 - (tamBot5 / 2) + tamBot5 &&
      ...
      if (numChampis2 > idealChampis2 || numChampis2 < idealChampis2 ||
        ...
        numAceitunas2 > idealAceitunas2 || numAceitunas2 < idealAceitunas2 ||
        numPepperoni2 > idealPepperoni2 || numPepperoni2 < idealPepperoni2 ||
        numTomate2 > idealTomate2 || numTomate2 < idealTomate2 ||
        numPimenton2 > idealPimenton2 || numPimenton2 < idealPimenton2) {
        ...
        numAceitunas2 == idealAceitunas2 ||
        numPepperoni2 == idealPepperoni2 ||
        numTomate2 == idealTomate2 ||
        numPimenton2 == idealPimenton2
      ) {
        estado = 24;
    ...
    if (mouseX > 100 && mouseY > 100 && mouseX < 650 && mouseY < 650) {
      ...
      if (ingredienteSel == 6) {
        //si se espicha boton tomate y despues se hace click sobre la pizza sale tomate
        tomate[tomate.length] = new tomatePos(mouseX, mouseY);
        numTomate2 = numTomate2 + 1;
        idealTomate2 = idealTomate2 + 1; 
      }
      if (ingredienteSel == 7) {
        //si se espicha boton pimenton y despues se hace click sobre la pizza sale pimenton
        pimenton[pimenton.length] = new pimentonPos(mouseX, mouseY);
        numPimenton2 = numPimenton2 + 1;
        idealPimenton2 = idealPimenton2 + 1;
      }
    ...
    if (mouseX > posXbot5 - (tamBot5 / 2) && mouseX < posXbot5 - (tamBot5 / 2) + tamBot5 &&
      ...
      if (idealChampis3 > idealChampis2 || idealChampis3 < idealChampis2 ||
        ...
        idealAceitunas3 > idealAceitunas2 || idealAceitunas3 < idealAceitunas2 ||
        idealPepperoni3 > idealPepperoni2 || idealPepperoni3 < idealPepperoni2 ||
        idealTomate3 > idealTomate2 || idealTomate3 < idealTomate2 ||
        idealPimenton3 > idealPimenton2 || idealPimenton3 < idealPimenton2) {
    ...
    //delimitar espacio en el que se pueden poner ingredientes dentro de la pizza
     if (mouseX > 100 && mouseY > 100 && mouseX < 650 && mouseY < 650) {
      ...
      if (ingredienteSel == 6) {
        //si se espicha boton tomate y despues se hace click sobre la pizza sale tomate
        tomate[tomate.length] = new tomatePos(mouseX, mouseY);
        numTomate3 = numTomate3 + 1;
        idealTomate3 = idealTomate3 + 1; 
      }
      if (ingredienteSel == 7) {
        //si se espicha boton pimenton y despues se hace click sobre la pizza sale pimenton
        pimenton[pimenton.length] = new pimentonPos(mouseX, mouseY);
        numPimenton3 = numPimenton3 + 1;
        idealPimenton3 = idealPimenton3 + 1;
      }
...
//boton para jugar dos personas
  ...
  //nivel 3 jugador 1 pasa a estado juego
  } else if (estado == 23) {
    estado = 12;
